	...
	return (
		<nav className="nav-bar">
			...
			<ul className="nav-options">
				...
				<li className="nav-link" onMouseOver={closeSearch}>
					<span>Products</span>
					<svg
			...
			<div className="nav-accessories">
				<div className="nav-tools">
					...
					<div className="cart-wishlist">
						<div className="cart" onMouseOver={showCart}>
						...
						<div className="wishlist" onMouseOver={showWishlist}>
				...
				<button className="sign-up-button primary-btn">
					<svg
						className="svg"
						width="41"
						height="40"
			...
			<SearchComponent addClass={isSearchClicked}/>
		</nav>
	);
};
