...
const PopularCategory = () => {
	return (
		<div className="main-popular-category-container">
			...
			<div className="popular-category-container">
					...
					<div className="watch-category">
						<ul>
							...
							<li className="shop-category-button">
								<a href="./" className="showcase-link shop-watch-category">SHOP NOW</a>
							</li>
						</ul>
					</div>
					<div className="iphone-homepod-category">
						<div className="iphone-category">
							<ul>
								...
								<li className="shop-category-button"><a href="./" className="showcase-link shop-watch-category">SHOP NOW</a></li>
							</ul>
						</div>
				...
				<div className="third-level">
					...
					<div className="airpod-category">
                        <img src={require('../../../assets/images/UI-images/airpods_max__cat.png')} alt="airpod"/>
                        <ul>
                            <li className="cateogry-name-section">
                                <svg
									className="apple-logo"
