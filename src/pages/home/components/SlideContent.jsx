	...
	return (
		<div className="slide-content-container">
			<div className="showcase-detail">
				<ul className="showcase-detail-list">
					<li className="showcase-category">
						...
						<span className="showcase-category-name">WATCH</span>
					</li>
					<li className="showcase-caption">The next level adventure</li>
					<li className="showcase-large-category-name">
						Apple
						<span className="showcase-category-name-large">Watch</span>
					</li>
					<li className="showcase-model">SERIES 9</li>
					<li>
			...
			<div className="showcase-image">
                <img className="hero-image" src={require('../../../assets/images/landing.png')} alt="landing-img" />
            </div>
		</div>
	);
};
